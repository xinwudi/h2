...
public class Explain extends Prepared {
    ...
    private void judgeType(ExpressionVisitor visitor, List listTablefilter, List listType, int i) {
        ...
        }else if (visitor.getTablefilters().get(i).getTable()!=null){
            if (visitor.getTablefilters().get(i).getTable().toString().contains(":")){
                listTablefilter.add(visitor.getTablefilters().get(i).toString().substring(0,visitor.getTablefilters().get(i).toString().indexOf(":")));
                visitor.setTablefilterya(listTablefilter);
            }else {
